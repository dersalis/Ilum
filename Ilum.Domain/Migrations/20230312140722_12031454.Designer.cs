...
namespace Ilum.Domain.Migrations
{
    ...
    [Migration("20230312140722_12031454")]
    partial class _12031454
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ilum.Domain.User.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 3, 12, 15, 7, 22, 168, DateTimeKind.Local).AddTicks(3750),
            ...
            modelBuilder.Entity("Ilum.Domain.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 3, 12, 15, 7, 22, 334, DateTimeKind.Local).AddTicks(7980),
                            CurrentPassword = "$2a$11$ih22QsdGM28FbFzsthfh1.qehSKOJKnX.toTcu1BFIewZYwsbaqZS",
                            DepartmentId = 1,
                            Email = "admin@wp.pl",
